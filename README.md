...
当前边界与验收：[系统路线](docs/systems-roadmap.md)、[显示问题核查](docs/health-and-remaining-audit.md)、[性能设计](docs/performance.md)。全技能/技能书、怪物规则与掉落、出售修理、任务社交、其他室内、小地图和BGM仍需继续完成与版本核对。
