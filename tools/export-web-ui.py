...
for i,(im,meta) in classic.read_library(folder/source['file'],[50,52,60,61,62,63,64,65,68,69,70,73,74,75,76,77,78,120,122,123,124,125,360,361,362,363,364,365,366,367,368,389,390]).items():
