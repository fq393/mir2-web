...
import {gainItem,consumeItem,equipmentTarget,storageDurability} from '../client/assets/scripts/core/inventory.ts';
...
test("warehouse durability follows Delphi Round including half-even ties",()=>{assert.deepEqual([0,500,501,1234,1500,2500,3500,6000].map(storageDurability),[0,0,1,1,2,2,4,6]);});
