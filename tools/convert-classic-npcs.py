#!/usr/bin/env python3
"""Original NPC 4/5/6: Delphi MA35, image*60 + direction*10 + frame."""
...
def build():
 ...
 actors={f'npc{i}':dict(stand=[[f'classicnpc:{i*60+d*10+f}' for f in range(4)] for d in range(3)],actionFrameMs=dict(stand=200)) for i in [4,5,6]}
 ...
 print('Exported 36 original NPC frames, 3 appearances x 3 directions x 4 stand frames')
