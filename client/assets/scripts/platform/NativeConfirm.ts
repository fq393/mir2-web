...
export class NativeConfirm {
 ...
 constructor(parent:HTMLElement,text:string,private choose:(accepted:boolean)=>void){
  ...
  for(const [name,image,x,accepted] of [['确认删除',363,104,true],['不删除',367,214,false],['取消删除',365,324,false]] as const){
