...
鸡的原素材、原音效、鸡肉定义和候选刷新已接入，来源与限制见 [城镇商人、鸡与二级旧货](regional-shops-and-chicken.md)。当前来源化配置为三种、68组、候选目标3455只；旧的52组记录仅指鹿与稻草人。历史配置可使用 `python3 tools/migrate-wildlife-profile.py` 追加新物种并备份，保留已有调参；当前配置没有缺失物种时不写入。
